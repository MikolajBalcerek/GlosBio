...
class TestSpectrogramPlotting(unittest.TestCase):
    ...
    def test_plot_spectrogram_pdf_success(self):
        # create a plot from test audio
        plot_bytesIO = plot_save_spectrogram(self.AUDIO_1_PATH, self.DIRECTORY_TEST, "pdf")

        # test assertion in-memory plot when saved is of the same size as expected
        test_in_memory_plot_path = f"{self.DIRECTORY_TEST}/test_in_memory_plot_spectrogram_pdf.pdf"
